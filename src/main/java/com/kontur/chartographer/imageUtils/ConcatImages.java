package com.kontur.chartographer.imageUtils;
...
public class ConcatImages {
    ...
    public static void concatBMPFiles(final String[] filenames, final String resultFilename) throws IOException, IllegalAccessException {
    ...
    public static byte[] concatBMPImageData(final byte[] ... imageDatas) throws IllegalAccessException {
        int newFileSize = 0;
        int newHeight = 0;
        int compWidth = -1;
